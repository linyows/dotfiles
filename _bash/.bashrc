...
# nvm
if [ -f ~/node_modules/nvm/nvm.sh ]; then
    . ~/node_modules/nvm/nvm.sh
fi
# rvm
...
# For git directories
#   jeremyf@jnf ~/ccs_portal (git::master) $
# For svn directories
#   jeremyf@jnf ~/ccs_main/app/controllers (svn::ccs_main/trunk) $
# {{{
    parse_git_branch() {
    ...
    export PS1='\[\033[00m\]\u@\h\[\033[01;34m\] \w \[$(branch_color)$(parse_git_branch)$(parse_svn_branch)\[\033[00m\]$\[\033[00m\] '
# }}}
